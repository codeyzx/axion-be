...
func RouteInit(r *fiber.App) {
	...
	r.Get("/auctions-export-excel", handler.AuctionExportToExcel)
	r.Get("/auctions-export-pdf", handler.AuctionExportToPDF)
	...
	r.Get("/auction-histories-export-excel", middleware.Admin, handler.AuctionHistoryExportToExcel)
	r.Get("/auction-histories-export-pdf", middleware.Admin, handler.AuctionHistoryExportToPDF)
	...
	r.Get("/products-export-excel", handler.ProductExportToExcel)
	r.Get("/products-export-pdf", handler.ProductExportToPDF)
